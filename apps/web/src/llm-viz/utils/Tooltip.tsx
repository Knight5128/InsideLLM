...
export const Tooltip: React.FC<{
    ...
    return <>
        {React.cloneElement(React.Children.only(children) as React.ReactElement<any>, { onMouseEnter: () => setIsVisible(true), onMouseLeave: () => setIsVisible(false), ref: setTargetEl })}
        {isVisible && <Portal>
